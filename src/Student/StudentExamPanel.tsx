...
export default function StudentExamPanel({ data, refresh }: { data: { profile?: Row; parent?: Row | null; examResources?: Row[]; hallTickets?: Row[]; onlineExams?: Row[]; onlineAttempts?: Row[] }; refresh: () => void }) {
